...
$(function(){
    ...
    chinaMap = chinaMap.concat(chinaCityMap);
    var currentData = [];
    var option = {
    		title: {
                text: '中国热门业余足球赛事',
    ...
    function autoroll(){
        ...
        chart.setOption(option);
        drawMap(hotNews.game_news_array);
    ...
    function convertData(dataList) {
        ...
        for (var i = 0; i < dataList.length; i++) {
            var data = dataList[i];
            var province = chinaMap.find(function(item, i){
    ...
    function drawMap(game_news_array){
    	for(var index = 0;index < game_news_array.length; index++){
    		var showList = [];
